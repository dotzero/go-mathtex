/****************************************************************************
 *
 * Copyright(c) 2007-2015, John Forkosh Associates, Inc. All rights reserved.
 ...
 * 06/18/15	J.Forkosh	Most recent change (see REVISIONDATE below)
 *
 ****************************************************************************/
...
Program ID
-------------------------------------------------------------------------- */
#define	VERSION "1.05c"			/* mathTeX version number */
#define	REVISIONDATE "18 Jun 2015"	/* date of most recent revision */
#define	COPYRIGHTDATE "2007-2015"	/* copyright date */
